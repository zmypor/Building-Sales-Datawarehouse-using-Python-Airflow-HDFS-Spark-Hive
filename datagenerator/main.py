...
if __name__ == "__main__":
    loadCsvToDatabase("./StaticDataset/color.csv", insertColor)
    loadCsvToDatabase("./StaticDataset/category.csv", insertCategory)
    loadCsvToDatabase("./StaticDataset/product.csv", insertProduct)
    loadCsvToDatabase("./StaticDataset/country.csv", insertCountry)
    loadCsvToDatabase("./StaticDataset/city.csv", insertCity)
    loadCsvToDatabase("./StaticDataset/address.csv", insertAddress)
